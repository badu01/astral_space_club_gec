  ...
  return (
    ...
    >
      <div className="flex flex-row justify-between">
        <div className="flex w-16 pb-24 justify-center items-end lg:justify-end lg:p-14 lg:pb-20  border-gray-400/50 lg:max-w-3xl lg:w-3xl h-screen">
        ...
        <div className=" w-full flex flex-col lg:flex-row justify-between max-h-[95vh] lg:max-h-[95vh]">
          <motion.div
            ...
            className="relative w-full h-full bg-cover bg-center p-10 lg:pb-20 flex flex-col justify-between overflow-hidden"
            style={{ backgroundImage: "url(assets/event_bg_1_1.png)" }}
          >
            {/* Gradient Overlay */}
            ...
            >
              ...
              <p className="text-xs lg:text-sm text-justify text-white">
          ...
          <motion.div
            ...
            className="relative w-full h-full bg-cover bg-center p-10 lg:pb-20 flex flex-col justify-between overflow-hidden"
            style={{ backgroundImage: "url(assets/event_bg_2_1.png)" }}
          >
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent pointer-events-none" />
            <Link
              to="/events/upcoming"
          ...
          <motion.div
            ...
            className="relative w-full h-full bg-cover bg-center p-10 lg:pb-20 flex flex-col justify-between overflow-hidden"
            style={{ backgroundImage: "url(assets/event_bg_3_1.png)" }}
          >
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent pointer-events-none" />
            <Link
              to="/events/ongoing"
